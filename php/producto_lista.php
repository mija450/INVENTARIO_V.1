            ...
            $tabla.='</p>
                ...
                <div class="media-content">
                    ...
                    <div class="has-text-right">
                        <a href="index.php?vista=product_img&product_id_up='.$rows['producto_id'].'" class="button is-link is-rounded is-small"><i class="fa-regular fa-image fa-fw"></i></a>

                        <a href="index.php?vista=product_update&product_id_up='.$rows['producto_id'].'" class="button is-success is-rounded is-small"><i class="fa-solid fa-arrows-rotate fa-fw"></i></a>

                        <a href="'.$url.$pagina.'&product_id_del='.$rows['producto_id'].'" class="button is-danger is-rounded is-small"><i class="fa-solid fa-trash-can fa-fw"></i></a>
                    </div>
                </div>
            </article>
