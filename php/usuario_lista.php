    ...
    if($total>=1 && $pagina<=$Npaginas){
        ...
        foreach($datos as $rows){
            ...
            <tr class="has-text-centered" >
                ...
                <td>
                    <a href="index.php?vista=user_update&user_id_up='.$rows['usuario_id'].'" class="button is-success is-rounded is-small"><i class="fa-solid fa-arrows-rotate fa-fw"></i></a>
                </td>
                <td>
                    <a href="'.$url.$pagina.'&user_id_del='.$rows['usuario_id'].'" class="button is-danger is-rounded is-small"><i class="fa-solid fa-trash-can fa-fw"></i></a>
                </td>
            </tr>
            ';
            $contador++;
