    ...
    if($total>=1 && $pagina<=$Npaginas){
        ...
        foreach($datos as $rows){
            ...
            <tr class="has-text-centered" >
                ...
                <td>
                    <a href="index.php?vista=product_category&category_id='.$rows['categoria_id'].'" class="button is-link is-rounded is-small"><i class="fa-solid fa-dolly fa-fw"></i> &nbsp; Ver</a>
                </td>
                <td>
                    <a href="index.php?vista=category_update&category_id_up='.$rows['categoria_id'].'" class="button is-success is-rounded is-small"><i class="fa-solid fa-arrows-rotate fa-fw"></i></a>
                </td>
                <td>
                    <a href="'.$url.$pagina.'&category_id_del='.$rows['categoria_id'].'" class="button is-danger is-rounded is-small"><i class="fa-solid fa-trash-can fa-fw"></i></a>
                </td>
            </tr>
            ';
            $contador++;
