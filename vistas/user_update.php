...
<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle"><i class="fa-solid fa-arrows-rotate fa-fw"></i> &nbsp; Actualizar datos de cuenta</h2>
    <?php }else{ ?>
    <h1 class="title">Usuarios</h1>
	<h2 class="subtitle"><i class="fa-solid fa-arrows-rotate fa-fw"></i> &nbsp; Actualizar usuario</h2>
    <?php } ?>
</div>
