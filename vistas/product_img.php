<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle"><i class="fa-regular fa-image fa-fw"></i> &nbsp; Actualizar imagen de producto</h2>
</div>
	...
	<div class="columns">
		<div class="column is-two-fifths">
			...
			<form class="FormularioAjax" action="./php/producto_img_eliminar.php" method="POST" autocomplete="off" >
				...
				<p class="has-text-centered">
					<button type="submit" class="button is-danger is-rounded"><i class="fa-solid fa-trash-can fa-fw"></i> &nbsp; Eliminar imagen</button>
				</p>
			</form>
			<?php }else{ ?>
			<figure class="image mb-6">
		...
		<div class="column">
			<form class="mb-6 has-text-centered FormularioAjax" action="./php/producto_img_actualizar.php" method="POST" enctype="multipart/form-data" autocomplete="off" >
				...
				<p class="has-text-centered">
					<button type="submit" class="button is-success is-rounded"><i class="fa-solid fa-arrows-rotate fa-fw"></i> &nbsp; Actualizar</button>
				</p>
			</form>
		</div>
	</div>
