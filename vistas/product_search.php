<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle"><i class="fa-solid fa-magnifying-glass fa-fw"></i> &nbsp; Buscar producto</h2>
</div>
    ...
    <div class="columns">
        <div class="column">
            <form class="has-text-centered mt-6 mb-6" action="" method="POST" autocomplete="off" >
                ...
                <p><i class="fa-solid fa-magnifying-glass fa-fw"></i> &nbsp; Estas buscando <strong>“<?php echo $_SESSION['busqueda_producto']; ?>”</strong></p>
                <br>
